...
const navItems = [
  { icon: BookOpen, label: "Knowledge Base", badge: "24" },
  { icon: FileText, label: "Documents" },
  { icon: Bot, label: "Agents", badge: "6" },
        ...
        >
          ...
          <div className="flex items-center gap-3 px-4 pt-5 pb-3">
            ...
            <div className="min-w-0 flex-1">
              ...
              <div className="text-xs text-muted-foreground truncate">Acme Workspace</div>
            </div>
          ...
          <div className="mt-auto p-3">
            <div className="flex items-center gap-3 rounded-xl border border-border bg-muted/30 p-2 pr-3">
              ...
              <div className="min-w-0 flex-1">
                <div className="truncate text-sm font-medium">Alex Rivera</div>
